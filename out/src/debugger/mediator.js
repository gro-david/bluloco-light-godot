    ...
    static notify(event, parameters = []) {
        ...
        switch (event) {
            ...
            case "start":
                ...
                (_z = this.controller) === null || _z === void 0 ? void 0 : _z.start(parameters[0], parameters[1], parameters[2], parameters[3], parameters[4], parameters[5], parameters[6], this.debug_data);
                break;
            case "debug_exit":
                break;
            case "stop":
