...
class ServerController {
    ...
    start(project_path, address, port, launch_instance, launch_scene, scene_file, additional_options, debug_data) {
        this.debug_data = debug_data;
        if (launch_instance) {
            let godot_path = utils.get_configuration("editorPath", "godot");
